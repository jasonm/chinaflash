...
and then use the HTPParty gem to make request to the API.
...
=== Bugs
This was done quickly and is not perfect.  If you notice a big, please submit an issue, or even better, fix it and submit a Pull Request.
=== Contributing
